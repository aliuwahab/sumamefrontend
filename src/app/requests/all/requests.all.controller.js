...
/** @ngInject */
function AllRequestsController($scope, $rootScope, $state, $timeout, $stateParams, Dialog,
  ...
  function activate() {
    ...
    var currentView = localStorageService.get('selectedRequestsView') || 'app.requests.all.pending';
