...
gulp.task('html', ['inject', 'partials'], function () {
    ...
    return gulp.src(path.join(conf.paths.tmp, '/serve/*.html'))
      ...
      .pipe($.ngAnnotate())
      .pipe($.uglify({
        // TODO: Enable mangling and solve issue with 'angular moment picker'
        mangle: false,
...
gulp.task('tinymcethemes', function () {
  return gulp.src('bower_components/tinymce/themes/**')
    .pipe(gulp.dest(path.join(conf.paths.dist, '/scripts/themes/')));
});

gulp.task('tinymceplugins', function () {
  return gulp.src('bower_components/tinymce/plugins/**')
  .pipe(gulp.dest(path.join(conf.paths.dist, '/scripts/plugins/')));
});

gulp.task('tinymceskins', function () {
